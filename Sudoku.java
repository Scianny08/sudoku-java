...
public class Sudoku {
    ...
    public static void main(String[] args) {
    	...
    	while (true) {
        	...
        	do {
        		System.out.print("Scegli un'azione (0-1): ");
        		while (!t.hasNextInt()) t.next(); //blocca l'input finché non viene inserito un numero
        		azione = t.nextInt();
        	...
        	switch (azione) {
        		...
        		case 1:
        	        ...
        	        do {
        	        	System.out.print("Scegli una difficoltà (1-5): ");
        	        	while (!t.hasNextInt()) t.next();
        	        ...
        	        boolean confermato;
        	        boolean uguali;
        	        int rigaSel = -1, colonnaSel = -1, num;
        	        int errori = 0;
        	        int contaNum = 0;
        	        ...
        	        while(errori < erroriMax && !uguali) {
        	        	...
        	        	do {
            	        	...
            	        	if (confermato) {
            	        		do {
                	        		...
                	        		if (colonnaSel == 0) confermato = false;
                	        	} while (colonnaSel < 0 || colonnaSel > 9);
            	        	}
            	        	
            	        	if (confermato) {
            	        		if (sudokuIrrisolto[rigaSel-1][colonnaSel-1] != 0) {
        	        	...
        	        	if (sudoku[rigaSel][colonnaSel] == num) {
        	        		sudokuIrrisolto[rigaSel][colonnaSel] = num;
